...
const routes: Routes = [
  ...
  , {
    ...
    , {
      path: 'crud',
      loadChildren: './crud/crud.module#CrudModule#RegisterModule',
      data: {
        customLayout: true
      }
    }
    ...
    , {
      path: 'people',
      loadChildren: './people/people.module#PeopleModule#RegisterModule',
      data: {
        customLayout: true
      }
    } 
   ...
   // , {
  //    path: 'crud',
  //    loadChildren: './crud/crud.module#TabsModule',
  //    data: {
  //      customLayout: true
  //          }
  //    }
